                    ...
                    <?php // Display Logo Image or Site Title
                        ...
                        if ( isset($options['themeZee_general_logo']) and $options['themeZee_general_logo'] <> "" ) : 
                            ...
                            $cate = $categories[0]->cat_ID;
                             $logo_check=get_cat_logo($cate);
                             if(!empty($logo_check)){
                                $logo_img=$logo_check;
                             }else{
                                $logo_img=esc_url($options['themeZee_general_logo']);;
                             }
                        ?>
        					<img class="logo-image" src="<?php echo $logo_img ; ?>" alt="Logo" /></a>
        			<?php else: ?>
